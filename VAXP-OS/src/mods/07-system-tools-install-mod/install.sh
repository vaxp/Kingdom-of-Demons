...
# Fix the package base-files to avoid system upgrading it. This is because Ubuntu may upgrade the package base-files and caused VAXP-OS to be changed to Ubuntu.
